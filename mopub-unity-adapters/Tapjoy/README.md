## Overview
  * This folder contains the configuration files required to integrate with the Tapjoy SDK.
  * To install or upgrade the Tapjoy SDK, please use the [SDK Manager](https://developers.mopub.com/docs/unity/getting-started/#sdkmanager) in the [MoPub Menu](https://developers.mopub.com/docs/unity/menu/) within Unity.
